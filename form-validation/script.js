$(document).ready(() => {
    ...
    const usernameValidation = () => {
        ...
        if (usernameValue.length === 0) {
            ...
            $("#username-validation").text("Username cannot be empty");
            usernameError = true;
    ...
    const passwordValidation = () => {
        ...
        if (passwordValue.length === 0) {
            ...
            $("#password-validation").text("Password cannot be empty");
            passwordError = true;
    ...
    const confirmPasswordValidation = () => {
        ...
        if (confirmPasswordValue.length === 0) {
            ...
            $("#confirmpassword-validation").text("Re-type cannot be empty");
